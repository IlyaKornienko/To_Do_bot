...
# Токен телеграм канала
token = '5103217770:AAGbXU5Bq8CFTdrmavSVsdHBjTmNSMqotMI'

bot = telebot.TeleBot(token)

RANDOM_TASKS = ["Сделать ToDo бота в Telegram", "Сделать сайт на Wordpress", "Сделать бот для отзывов в Studio_Odintsovoy", "Сделать сайт портфолио", "Добавить код в GitHub"]
